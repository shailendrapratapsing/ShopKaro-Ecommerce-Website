...
const AdminUpdateProduct = () => {
  ...
  const getInputData = (e) => {
    ...
    ? data.pic.concat(Array.from(e.target.files).map((file) =>"product/" + file.name)) : e.target.value;
            ...
            <div className="my-3">
              <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      value={data.color}
                      className={`form-control ${
                        show && error.color ? "border-danger" : "border-primary"
                      } border-3 mb-3`}
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      value={data.size}
                      className={`form-control ${
                        show && error.size ? "border-danger" : "border-primary"
                      } border-3 mb-3`}
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-md-6">
                    <label className="mb-2">Old pic (click here to remove)</label><br/>
                    {data.pic.map((item,ind)=>{
                    return <img  key={ind} onClick={()=>{
                    data.pic.splice(ind,1)
                    setFlag(!flag)  }} 
                    src={`${process.env.REACT_APP_BACKEND_SERVER}/${item}`} alt="product img" width={80} height={80} className="me-2"/   >
