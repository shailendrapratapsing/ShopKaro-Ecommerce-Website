...
export default function Testimonials() {
    ...
    let dispatch = useDispatch()
     ...
     let [slidesPerView, setSlidesPerView] = useState(window.innerWidth < 1000 ? 1 : 3)
           ...
           let options = {
               ...
               loop: TestimonialStateData.length > slidesPerView,
               navigation:true,
               pagination: false,
    ...
    let duplicateData = TestimonialStateData.length < slidesPerView ? [...TestimonialStateData, ...TestimonialStateData] : TestimonialStateData
        ...
        <>
            <div className="container-fluid testimonial py-5 mb-5">
                <div className="container overflow-hidden">
                    ...
                    <Swiper {...options}>
                    {duplicateData && duplicateData.filter(x => x.active).map(item => {
                            return <SwiperSlide key={item.id}>
                                <div className="testimonial-item border p-4">
                                    ...
                                    <div className="border-top mt-4 pt-3">
                                        <p className="ps-2 pe-4 testimonial-message w-100">{item.message}</p>
                                    </div>
                                </div>
                            </SwiperSlide>
                        })}
